...
|---|---|---|---|
| `osmium-2.5.0-arm64-v8a.apk` | arm64-v8a | Virtually all modern phones (recommended) | [GitHub](https://github.com/lihongxi-g/osmium-authenticator/releases/download/v2.5.0/osmium-2.5.0-arm64-v8a.apk) |
| `osmium-2.5.0-armeabi-v7a.apk` | armeabi-v7a | Older 32-bit phones | [GitHub](https://github.com/lihongxi-g/osmium-authenticator/releases/download/v2.5.0/osmium-2.5.0-armeabi-v7a.apk) |
| `osmium-2.5.0-x86_64.apk` | x86_64 | Android emulators | [GitHub](https://github.com/lihongxi-g/osmium-authenticator/releases/download/v2.5.0/osmium-2.5.0-x86_64.apk) |
...
APK SHA-256 checksums are listed in the [v2.5.0 release notes](release-notes-v2.5.0.md) and on the GitHub Release page.
