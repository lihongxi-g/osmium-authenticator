...
These documents describe WebDAV backup and restore in Osmium v2.4.3. WebDAV backup and LAN quick transfer are separate features: WebDAV connects to a backup server you configure; LAN transfer connects to another device on the same Wi‑Fi.
