...
fun ManualScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            ManualSection(R.string.manual_naming_title, R.string.manual_naming_body)
            ...
            ManualSection(R.string.manual_auto_backup_title, R.string.manual_auto_backup_body)
            ManualSection(R.string.manual_updates_title, R.string.manual_updates_body)
