...
data class DevStrings(
    ...
    val detailedLogging: String,
    val detailedLoggingDesc: String,
    val exitDevMode: String,
    val exitDevModeDesc: String,
    val previewUpdate: String,
    val previewUpdateDesc: String,
    val previewUpdateFailed: String,
    // common
    val on: String,
    val off: String,
    val confirm: String,
    ...
    // plaintext import (developer mode, shown on the vault import screen)
    val plainImportLabel: String,
    val plainImportHint: String,
    val plainImportError: String,
    val plainImportDetected: String,
    // misc results
    ...
    companion object {
        ...
        private val EN = DevStrings(
            ...
            detailedLogging = "Detailed detection logging",
            detailedLoggingDesc = "Write device-integrity detection details into the in-app log (off by default)",
            exitDevMode = "Turn off developer mode",
            exitDevModeDesc = "Also resets the dangerous toggles",
            previewUpdate = "Preview the update dialog",
            previewUpdateDesc = "Show the release notes dialog with the newest GitHub release",
            previewUpdateFailed = "Could not fetch the latest release",
            on = "On",
            off = "Off",
            confirm = "Confirm",
            cancel = "Cancel",
            ...
            plainImportLabel = "Plaintext backup (no password)",
            plainImportHint = "Import a file created by developer-mode plaintext export — no backup password is needed.",
            plainImportError = "Not a valid plaintext backup file. If this is a password-encrypted backup, untick the option above and enter its password.",
            plainImportDetected = "This file looks like a plaintext backup — tick \"Plaintext backup\" above to import it.",
        ...
        private val ZH = DevStrings(
            ...
            detailedLogging = "检测详细日志",
            detailedLoggingDesc = "将设备完整性检测细节写入应用内日志（默认关闭）",
            exitDevMode = "关闭开发者模式",
            exitDevModeDesc = "同时重置危险开关",
            previewUpdate = "预览更新弹窗",
            previewUpdateDesc = "拉取 GitHub 上最新 Release 的说明，看更新内容弹窗长什么样",
            previewUpdateFailed = "无法获取最新 Release",
            on = "已开启",
            off = "已关闭",
            confirm = "确认",
            cancel = "取消",
            ...
            plainImportLabel = "明文备份（无密码导入）",
            plainImportHint = "用于导入开发者模式「明文导出」产生的文件，无需输入备份密码。",
            plainImportError = "不是有效的明文备份文件。如果它是加密备份，请取消勾选上方选项并输入密码。",
            plainImportDetected = "这看起来是明文备份文件——请勾选上方「明文备份」后重试。",
            devEnabled = "开发者模式已开启",
